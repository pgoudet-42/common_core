...
template<typename T>
void	displayVect(vector<T> vect, string name) {
	cout << name << " = ";
...
int	main(void) {
	...
	vector<string>::iterator it1 = test3.begin();
	cout << "it1 value = " << *it1 << endl;
  	vector<string>::iterator ite1 = test3.end();
	cout << "it1 value = " << *ite1 << endl;
	vector<string>::reverse_iterator rit1 = test3.rbegin();
  ...
  cout << "it1 == ite1 = " << (it1 == ite1) << endl;
	...
	cout << "m1[a] = " << m1['a'] << endl;
	cout << "m1[g] = " << m1['g'] << endl;
	map<char, int>::iterator itm = m1.begin();
	itm++;
	...
	cout << "m1[a] = " << m1['a'] << endl;
	cout << "m1[b] = " << m1['b'] << endl;
	map<char, int>::iterator itm2 = m1.find('f');
	cout << "itm2 = " << itm2->first << itm2->second << endl;
	cout << "m1 count = " << m1.count('g') << endl;
	map<char, int>::iterator itm3 = m1.lower_bound('f');
	map<char, int>::iterator itm4 = m1.upper_bound('a');
	...
	map<string, string> m5(m4);
	cout << "m4 size = " << m4.size() << endl;
	cout << "m4[a] = " << m4["a"] << endl;
	cout << "m4[a] = " << m4["g"] << endl;
	map<string, string>::iterator itm44 = m4.begin();
	map<string, string>::reverse_iterator itmr44 = m4.rbegin();
  	map<string, string>::reverse_iterator itmr45 = m4.rend();
	...
	swap(m4, m5);
	map<string, string>::iterator itm22 = m4.find("f");
	cout << "itm2 = " << itm22->first << itm2->second << endl;
	cout << "m4 count = " << m4.count("f") << endl;
	map<string, string>::iterator itm33 = m4.lower_bound("f");
	map<string, string>::iterator itm45 = m4.upper_bound("a");
